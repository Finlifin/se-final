defmodule FlixBackend.Repo.Migrations.FixIdTypes do
  use Ecto.Migration
  ...
  def change do
    ...
    create table(:users, primary_key: false) do
      add :uid, :binary_id, primary_key: true, default: fragment("uuid_generate_v4()")
      ...
      add :favorited_product_ids, {:array, :binary_id}, default: []
    ...
    create table(:accounts, primary_key: false) do
      ...
      add :user_id, references(:users, column: :uid, type: :binary_id)
    ...
    # 重新创建 products 表，使用 binary_id 作为主键
    create table(:products, primary_key: false) do
      add :id, :binary_id, primary_key: true, default: fragment("uuid_generate_v4()")
      # 外键，关联到 UUID 类型的 uid
      add :seller_id, references(:users, column: :uid, type: :binary_id), null: false
      add :title, :string
    ...
    # 重新创建 orders 表，使用 binary_id 作为主键
    create table(:orders, primary_key: false) do
      add :order_id, :binary_id, primary_key: true, default: fragment("uuid_generate_v4()")
      add :buyer_id, references(:users, column: :uid, type: :binary_id), null: false
      add :seller_id, references(:users, column: :uid, type: :binary_id), null: false
      add :product_id, references(:products, column: :id, type: :binary_id), null: false
